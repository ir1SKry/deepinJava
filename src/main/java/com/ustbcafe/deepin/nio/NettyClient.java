...
import com.ustbcafe.deepin.nio.codec.LengthBasedEncoder;
import com.ustbcafe.deepin.nio.handler.ByteMessageClientHandler;
...
public class NettyClient {
    ...
    public void run() throws  Exception{
        ...
        try{
            ...
            b.handler(new ChildLengthMessageChannelHandler());
    ...
    private class ChildLengthMessageChannelHandler extends ChannelInitializer<SocketChannel>{
        @Override
        protected void initChannel(SocketChannel socketChannel) throws Exception {
            socketChannel.pipeline().addLast(new LengthBasedEncoder());
            socketChannel.pipeline().addLast(new ByteMessageClientHandler());
        }
    }
}
